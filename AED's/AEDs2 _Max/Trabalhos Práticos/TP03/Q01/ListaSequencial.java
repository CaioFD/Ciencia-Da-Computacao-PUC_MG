...
class Lista {
    ...
    public void inserirInicio ( Personagem perso ) throws Exception{
    ...
    public void inserir ( Personagem perso, int index ) throws Exception{
        if( index >= personagem.length || index < 0 || this.tamanho < index ) {
    ...
    public Personagem removerFim ( ) throws Exception{
        ...
        this.tamanho--;
        personagem = this.personagem[tamanho];
        return ( personagem );
    } // end removerFim ( )
    ...
    public Personagem remover ( int index ) throws Exception{
        ...
        personagem = this.personagem[index];
        this.tamanho--;
...
public class ListaSequencial extends Personagem
{
