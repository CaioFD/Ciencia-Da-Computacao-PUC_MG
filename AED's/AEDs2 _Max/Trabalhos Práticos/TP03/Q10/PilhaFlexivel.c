...
Personagem* clone( Personagem *perso )//CLONAR PERSONAGEM
{
...
void imprimir ( Personagem *perso )//IMPRIMIR PERSONAGEM
{
...
void imprimir2 ( int id, Personagem *perso )//IMPRIMIR PERSONAGEM 2
{
...
Personagem* ler( char* filename, char* id_procurado ) // LÊ PERSONAGEM DE UM ARQUIVO
{
...
void inserir ( Pilha* pilha, Personagem* perso )//INSERIR PERSONAGEM NA PILHA
{
...
Personagem* remover ( Pilha* pilha )//REMOVER PERSONAGEM DA PILHA
{
    if( pilha->topo == NULL )
    {
        printf( "\n%s\n", "ERRO: Pilha Vazia!" );
...
void mostrar ( Pilha* pilha )//MOSTRAR PERSONAGENS NA PILHA
{
    int j = 0;
    printf( "[ Top ]\n" );
