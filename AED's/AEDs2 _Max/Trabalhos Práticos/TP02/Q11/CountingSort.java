...
setWizard          ( wizard );
   ...
   //--------- Métodos Uteis ---------//
                ...
                public static void CountingSort( List<Personagem> perso, Log log ) 
    {
        ...
        int[] count = new int[getMaior( perso) + 1];
...
public static int getMaior( List<Personagem> perso ) 
{
...
public class CountingSort extends Personagem
{
    public static void main ( String [] args )
    {
        Scanner scan = new Scanner( System.in );
        
        Log log = new Log( "793605_countingsort.txt" );
        Personagem perso = new Personagem( );
